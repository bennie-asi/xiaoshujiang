...
![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671854182460.png)
## 环境部署
...
> template最外层类名一般命名为content或者wrapper，如图所示![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671854182461.png)
...
> ![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671854182467.png)

## 项目结构
![项目结构](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671854182468.png)
#### **colorui**
引入的一个外部CSS库，目前官网`https://www.color-ui.com/` 已经打不开了，其中的main.css可以根据项目需要来对标签进行一些全局修改，如去掉一些默认样式。
#### **common**
![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671854182469.png)
...
#### components
存放着封装好的项目组件与通用组件，一般小组件以单个文件组成，大组件才需用文件夹将组件包裹，项目组件一般以项目名与组件名通过短横线连接方式命名，通用组件则以ir与组件名通过短横线连接方式命名,如下图所示![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671854182472.png)
#### pages
uni-app固定pages中存放页面文件，需要注意的是分包问题，不同的小程序平台对分包的要求不一样，如需分包，一般在home\index文件夹存放tabbar的页面，然后每个tabbar作为一个文件夹，分包相关查看[uniapp分包详尽版](https://zhuanlan.zhihu.com/p/426186756)，组织结构如下所示![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671854182473.png)
#### static
