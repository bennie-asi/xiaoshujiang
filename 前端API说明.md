...
### 通用类方法
通用类方法位于`项目/common/common.js`路径下，主要包含给予用户提示、路由（页面）、上传下载（图片、视频）、存储（storage）等。详见思维导图。![通用类方法](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853518512.png)
 仅对分级为很重要的方法进行使用说明
#### $toast/$errtoast()
``` js
...
## 引入阿里巴巴矢量图标库
 1. 首先需要注册并登录[阿里巴巴矢量图标](https://www.iconfont.cn/home/index)，接着加入或者创建项目，![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853517750.png)进入如图界面。
 2. 使用Hbuilder X打开前端项目，打开App.vue文件，根据项目文件路径在style中添加如下语句。![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853517757.png)
...
```
 4.  打开阿里巴巴矢量图标库，点击项目设置，并更改设置为下图所示（记得保存），![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853517758.png)![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853517759.png)
   

 
  5. 点击生成在线链接，并复制生成的链接代码。如下图所示![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853517760.png)
 6. 将复制的代码粘贴至i`rIcon.css`文件中![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853517761.png)
 7. 在阿里巴巴矢量图标库中找到所需图标，记住图标的unicode码与Font class名称![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853517762.png)
 8. 将unicode与font class 粘贴至irIcon.css文件中，具体操作如下![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853517763.png)
 9. 在项目中使用图标，直接使用Font class即可![enter description here](https://gitee.com/liu-bennie/imgbed/blob/master/xiaoshujiang/1671853518510.png)
